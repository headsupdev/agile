...
/**
 * Permission that allows users to edit a milestone
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class MilestoneEditPermission
    implements Permission
{
    private String id = "MILESTONE-EDIT";
    private String description = "Edit milestone permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public MilestoneEditPermission()
    {
