...
package org.headsupdev.agile.app.milestones.permission;
...
/**
 * Permission that allows users to view a milestone list
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class MilestoneListPermission
    implements Permission
{
    private String id = "MILESTONE-LIST";
    private String description = "View milestone list permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public MilestoneListPermission()
    {
