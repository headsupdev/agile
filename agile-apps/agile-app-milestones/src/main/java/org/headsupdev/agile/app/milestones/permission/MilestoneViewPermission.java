...
/**
 * Permission that allows users to view a milestone
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class MilestoneViewPermission
    implements Permission
{
    private String id = "MILESTONE-VIEW";
    private String description = "View milestone permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public MilestoneViewPermission()
    {
