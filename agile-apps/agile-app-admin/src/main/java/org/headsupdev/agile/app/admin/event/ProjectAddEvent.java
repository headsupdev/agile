 ...
 */
@Entity
@DiscriminatorValue( "projectadd" )
public class ProjectAddEvent
    extends AbstractEvent
{
    ...
    {
        super( "Project " + project.getName() + " was added",
               "The project \"" + project.getName() + "\" was added from scm url " +
                   project.getScm(), new Date() );
