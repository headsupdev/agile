...
/**
 * Permission that allows users to view a member's profile
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class MemberViewPermission
    implements MemberPermission
{
    private String id = "MEMBER-VIEW";
    private String description = "View member permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public MemberViewPermission()
    {
