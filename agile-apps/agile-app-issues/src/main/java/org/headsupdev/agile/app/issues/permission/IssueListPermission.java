...
/**
 * Permission that allows users to view an issue list
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class IssueListPermission
    implements Permission
{
    private String id = "ISSUE-LIST";
    private String description = "View issue list permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public IssueListPermission()
    {
