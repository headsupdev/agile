...
/**
 * Permission that allows users to view an issue
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class IssueViewPermission
    implements Permission
{
    private String id = "ISSUE-VIEW";
    private String description = "View issue permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public IssueViewPermission()
    {
