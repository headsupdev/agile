...
/**
 * Permission that allows users to force a build
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class BuildForcePermission
    implements Permission
{
    private String id = "BUILD-FORCE";
    private String description = "Force build permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public BuildForcePermission()
    {
