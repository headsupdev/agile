...
/**
 * Permission that allows users to view a build list
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class BuildListPermission
    implements Permission
{
    private String id = "BUILD-LIST";
    private String description = "View build list permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public BuildListPermission()
    {
