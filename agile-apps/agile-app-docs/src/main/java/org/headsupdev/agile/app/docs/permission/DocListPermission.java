...
package org.headsupdev.agile.app.docs.permission;
...
/**
 * Permission that allows users to view a document list
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class DocListPermission
    implements Permission
{
    private String id = "DOC-LIST";
    private String description = "View document list permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public DocListPermission()
    {
