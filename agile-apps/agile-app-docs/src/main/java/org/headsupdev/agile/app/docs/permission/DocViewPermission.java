...
/**
 * Permission that allows users to view documents
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class DocViewPermission
    implements Permission
{
    private String id = "DOC-VIEW";
    private String description = "View document permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public DocViewPermission()
    {
