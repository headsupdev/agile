...
/**
 * Permission that allows users to edit documents
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class DocEditPermission
    implements Permission
{
    private String id = "DOC-EDIT";
    private String description = "Edit document permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public DocEditPermission()
    {
