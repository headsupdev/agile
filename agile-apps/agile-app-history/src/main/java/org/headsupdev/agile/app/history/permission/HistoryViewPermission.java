...
package org.headsupdev.agile.app.history.permission;
...
/**
 * Permission that allows users to view the event history
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class HistoryViewPermission
    implements Permission
{
    private String id = "HISTORY-VIEW";
    private String description = "View activity permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public HistoryViewPermission()
    {
