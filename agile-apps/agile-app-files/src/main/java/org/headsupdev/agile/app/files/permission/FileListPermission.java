...
/**
 * Permission that allows users to view files listings in the scm browser
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class FileListPermission
    implements Permission
{
    private String id = "FILE-LIST";
    private String description = "View version control file listings permission";
