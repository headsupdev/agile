...
package org.headsupdev.agile.app.files.permission;
...
/**
 * Permission that allows users to view files in the scm browser
 *
 * @author Andrew Williams
 * @version $Id$
 * @since 1.0
 */
public class FileViewPermission
    implements Permission
{
    private String id = "FILE-VIEW";
    private String description = "View version control file permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public FileViewPermission()
    {
