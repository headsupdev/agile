 ...
 * @since 1.0
 */
public class ProjectListPermission
    implements Permission
{
    private String id = "PROJECT-LIST";
    private String description = "Project list permission - required to see the project list and related pages";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public ProjectListPermission()
    {
