...
/**
 * Permission that allows users to view the list of running tasks etc
 *
...
{
    private String id = "TASK-LIST";
    private String description = "View task list permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public TaskListPermission()
    {
