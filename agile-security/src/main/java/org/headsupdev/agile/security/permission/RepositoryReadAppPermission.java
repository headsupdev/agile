 ...
 * @since 2.2
 */
public class RepositoryReadAppPermission
    implements Permission
{
    private String id = "REPOSITORY-READ-APPS";
    private String description = "Read apps repository permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public RepositoryReadAppPermission()
    {
