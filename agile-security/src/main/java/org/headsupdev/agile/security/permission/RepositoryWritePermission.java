 ...
 * @since 1.0
 */
public class RepositoryWritePermission
    implements Permission
{
    private String id = "REPOSITORY-WRITE";
    private String description = "Write repository permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public RepositoryWritePermission()
    {
