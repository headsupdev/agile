 ...
 * @since 1.0
 */
public class RepositoryReadPermission
    implements Permission
{
    private String id = "REPOSITORY-READ";
    private String description = "Read repository permission";

    private transient List<String> defaultRoles = new LinkedList<String>();

    public RepositoryReadPermission()
    {
