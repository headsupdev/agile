...
/**
 * A version control service interface that will be implemented by the loaded SCM / browse service
 *
...
{
    ChangeSet getLastChange( Project project );

    ChangeSet getChangeSet( Project project, String revision );
